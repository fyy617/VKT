...
def main():
    ...
    train_dataset = datasets.ImageFolder(root="/path/to/train", transform=data_transform["train"])
    ...
    train_loader = torch.utils.data.DataLoader(train_dataset,
                                               ...
                                               num_workers=nw)
    validate_dataset = datasets.ImageFolder(root="/path/to/val", transform=data_transform["val"])
